...
This test demonstrates the correct architecture:
  1. MSAL acquires the token and returns:
     ...
     - app developer constructs the authorization header from token_type
       + access_token
...
Usage:
    set RUN_E2E_TESTS=1 && python -m pytest tests/test_e2e_mtls_pop.py -v
    OR
...
class TestMtlsPopE2E(unittest.TestCase):
    ...
    def test_acquire_token_and_call_akv(self):
        ...
        if E2E_CLIENT_ID:
            ...
            mi = UserAssignedManagedIdentity(client_id=E2E_CLIENT_ID)
