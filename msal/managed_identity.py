...
class ManagedIdentityClient(object):
    ...
    def acquire_token_for_client(
        ...
        *,
        ...
        For the standard (MSI v1) flow, the result will be automatically cached.
        Subsequent calls will automatically search from cache first.

        For the MSI v2 (mTLS PoP) flow, the certificate is cached internally
        but each call acquires a fresh token from ESTS via mTLS.
